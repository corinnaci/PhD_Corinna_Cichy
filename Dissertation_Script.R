# This is code to replicate the implementation 
...
#read input
DQ_data <- read_excel(input_file)

#construct fuzzy sets
#conduct fuzzy c-means clustering with c=3 for each feature
...
#define membership functions using cluster centers
...
vali2 <- 	fuzzy_variable(
  ...
  high = 
    fuzzy_triangular(corners = c(99.60, 100, 110)))
...
summary(lmDQ_AIC) #obtain model parameters
