...
str(finaldata) # initial data overview
plot(finaldata$Access1, finaldata$Quality, main = "", xlab = "Access1", ylab = "Score") 
# repeat for Comp1, Comp2, Vali1, Vali2, Accur1, Accur2, Inte1, Inte2
hist(finaldata$Access1, breaks = 50, main = "", xlab = "Access1") 
# repeat for Comp1, Comp2, Vali1, Vali2, Accur1, Accur2, Inte1, Inte2
ggpairs(finaldata, columns = 2:10) # optional, scatterplot matrix incl. correlations
...
# model diagnostics
plot(lmDQ_AIC) # obtain diagnostic plots
acf(lmDQ_AIC$residuals) # obtain autocorrelation plot
dwtest(lmDQ_AIC) # perform Durbin Watson test
bptest(lmDQ_AIC) # perform Breusch-Pagan Test
