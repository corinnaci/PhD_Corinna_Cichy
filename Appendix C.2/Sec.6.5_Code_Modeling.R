...
plot(DQ_data$Access1, DQ_data$Quality, main = "", xlab = "Access1", ylab = "Score") 
# repeat for Comp1, Comp2, Vali1, Vali2, Accur1, Accur2, Inte1, Inte2
hist(DQ_data$Access1, breaks = 50, main = "", xlab = "Access1") 
# repeat for Comp1, Comp2, Vali1, Vali2, Accur1, Accur2, Inte1, Inte2
ggpairs(DQ_data, columns = 2:10) # optional, scatterplot matrix incl. correlations
